...
public class AnimatorModelTest {
  ...
  public void setUp() {
    ...
    this.model.move("c", 500,400,500,100,20,50);
  ...
  public void testGetAnimation() {
    assertEquals("Shapes:\n" +
            ...
            "Shape c moves from (500.0,100.0to (500.0,400.0) from t=20 to t=50\n" +
            "Shape c changes color from (0.0,0.0,1.0) to (0.0,1.0,0.0) from t=50to t=80\n" +
