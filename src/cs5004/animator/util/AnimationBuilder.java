...
public interface AnimationBuilder<Animator> {
   ...
   */
  AnimationBuilder<Animator> setBounds(int x, int y, int width, int height);
   ...
   * @return This {@link AnimationBuilder}
   */
  AnimationBuilder<Animator> declareShape(String name, String type);
   ...
   * @return This {@link AnimationBuilder}
   */
  AnimationBuilder<Animator> addMotion(String name,
